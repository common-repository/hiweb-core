...
jQuery(document).ready(function(){
    ...
    ///Name Change
    jQuery('.hiweb-core-settings-adminmenu-table input[data-type="rename"]').on('keydown', function(){
        var t = jQuery(this);
        var val = t.val();
    ...
    ///Change On Air
    jQuery('.hiweb-core-settings-adminmenu-table select').live('change', function(){
        var user = jQuery('#hiweb-core-settings-adminmenu-currentuser').val();
        var role = jQuery('#hiweb-core-settings-adminmenu-currentrole').val();
    ...
    jQuery('#hiweb-core-settings-adminmenu-submit').click(function(){
        jQuery('.hiweb-core-settings-adminmenu-table select').eq(0).trigger('change');
