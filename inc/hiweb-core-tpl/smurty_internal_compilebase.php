<?php
/**
 * hiweb_tpl Internal Plugin CompileBase
 *
 * @package    hiweb_tpl
 * @subpackage Compiler
 * @author     Uwe Tews
 ...
 * @subpackage Compiler
 */
abstract class Smurty_Internal_CompileBase
{
    /**
    ...
    public function closeTag($compiler, $expectedTag)
    {
        if (count($compiler->_tag_stack) > 0) {
            ...
            $compiler->trigger_template_error("unclosed {$compiler->smurty->left_delimiter}" . $_openTag . "{$compiler->smurty->right_delimiter} tag");
