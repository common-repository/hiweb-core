...
/**
 * hiweb_tpl Internal Plugin Templateparser
...
#line 13 "smurty_internal_templateparser.y"
class Smurty_Internal_Templateparser#line 80 "smurty_internal_templateparser.php"
{
    #line 15 "smurty_internal_templateparser.y"

    const Err1 = "Security error: Call to private object member not allowed";
    const Err2 = "Security error: Call to dynamic object member not allowed";
    const Err3 = "PHP in template not allowed. Use hiweb_tplChild to enable it";
    ...
    function __construct($lex, $compiler)
    {
        ...
        $this->smurty = $this->compiler->smurty;
        $this->template = $this->compiler->template;
        $this->compiler->has_variable_string = false;
        $this->compiler->prefix_code = array();
        $this->block_nesting_level = 0;
        if ($this->security = isset($this->smurty->security_policy)) {
            $this->php_handling = $this->smurty->security_policy->php_handling;
        } else {
            $this->php_handling = $this->smurty->php_handling;
        }
        $this->is_xml = false;
        $this->asp_tags = (ini_get('asp_tags') != '0');
        $this->current_buffer = $this->root_buffer = new _smurty_template_buffer($this);
    }
    ...
    public function compileVariable($variable)
    {
        ...
        //       return '(isset($_smurty_tpl->tpl_vars['. $variable .'])?$_smurty_tpl->tpl_vars['. $variable .']->value:$_smurty_tpl->getVariable('. $variable .')->value)';
        return '$_smurty_tpl->tpl_vars[' . $variable . ']->value';
    }

    #line 139 "smurty_internal_templateparser.php"
    ...
    const TP_SMURTYBLOCKCHILDPARENT = 35;
    ...
    public $yyTokenName = array(
        ...
        'AS', 'APTR', 'LDELSETFILTER', 'SMURTYBLOCKCHILDPARENT',
        ...
        'start', 'template', 'template_element', 'smurtytag',
    ...
    public static $yyRuleName = array(
        ...
        "template ::=",
        /*   4 */
        "template_element ::= smurtytag RDEL",
        /*   5 */
        ...
        /*  29 */
        "smurtytag ::= LDEL value",
        /*  30 */
        "smurtytag ::= LDEL value modifierlist attributes",
        /*  31 */
        "smurtytag ::= LDEL value attributes",
        /*  32 */
        "smurtytag ::= LDEL expr modifierlist attributes",
        /*  33 */
        "smurtytag ::= LDEL expr attributes",
        /*  34 */
        "smurtytag ::= LDEL DOLLAR ID EQUAL value",
        /*  35 */
        "smurtytag ::= LDEL DOLLAR ID EQUAL expr",
        /*  36 */
        "smurtytag ::= LDEL DOLLAR ID EQUAL expr attributes",
        /*  37 */
        "smurtytag ::= LDEL varindexed EQUAL expr attributes",
        /*  38 */
        "smurtytag ::= LDEL ID attributes",
        /*  39 */
        "smurtytag ::= LDEL ID",
        /*  40 */
        "smurtytag ::= LDEL ID PTR ID attributes",
        /*  41 */
        "smurtytag ::= LDEL ID modifierlist attributes",
        /*  42 */
        "smurtytag ::= LDEL ID PTR ID modifierlist attributes",
        /*  43 */
        "smurtytag ::= LDELIF expr",
        /*  44 */
        "smurtytag ::= LDELIF expr attributes",
        /*  45 */
        "smurtytag ::= LDELIF statement",
        /*  46 */
        "smurtytag ::= LDELIF statement attributes",
        /*  47 */
        "smurtytag ::= LDELFOR statements SEMICOLON optspace expr SEMICOLON optspace DOLLAR varvar foraction attributes",
        /*  48 */
        "foraction ::= EQUAL expr",
        /*  49 */
        "foraction ::= INCDEC",
        /*  50 */
        "smurtytag ::= LDELFOR statement TO expr attributes",
        /*  51 */
        "smurtytag ::= LDELFOR statement TO expr STEP expr attributes",
        /*  52 */
        "smurtytag ::= LDELFOREACH attributes",
        /*  53 */
        "smurtytag ::= LDELFOREACH SPACE value AS DOLLAR varvar attributes",
        /*  54 */
        "smurtytag ::= LDELFOREACH SPACE value AS DOLLAR varvar APTR DOLLAR varvar attributes",
        /*  55 */
        "smurtytag ::= LDELFOREACH SPACE expr AS DOLLAR varvar attributes",
        /*  56 */
        "smurtytag ::= LDELFOREACH SPACE expr AS DOLLAR varvar APTR DOLLAR varvar attributes",
        /*  57 */
        "smurtytag ::= LDELSETFILTER ID modparameters",
        /*  58 */
        "smurtytag ::= LDELSETFILTER ID modparameters modifierlist",
        /*  59 */
        "smurtytag ::= LDEL SMURTYBLOCKCHILDPARENT",
        /*  60 */
        "smurtytag ::= LDELSLASH ID",
        /*  61 */
        "smurtytag ::= LDELSLASH ID modifierlist",
        /*  62 */
        "smurtytag ::= LDELSLASH ID PTR ID",
        /*  63 */
        "smurtytag ::= LDELSLASH ID PTR ID modifierlist",
        /*  64 */
        ...
        /* 202 */
        "doublequotedcontent ::= smurtytag RDEL",
        /* 203 */
    ...
    public function yy_shift($yyNewState, $yyMajor, $yypMinor)
    {
        ...
        if ($this->yyidx >= self::YYSTACKDEPTH) {
            ...
            #line 91 "smurty_internal_templateparser.y"

            $this->internalError = true;
            $this->compiler->trigger_template_error("Stack overflow in template parser");
            #line 1699 "smurty_internal_templateparser.php"
    ...
    #line 102 "smurty_internal_templateparser.y"
    function yy_r0()
    {
        $this->_retvalue = $this->root_buffer->to_smurty_php();
    }
    #line 2140 "smurty_internal_templateparser.php"
    #line 110 "smurty_internal_templateparser.y"
    function yy_r1()
    {
    ...
    #line 2147 "smurty_internal_templateparser.php"
    #line 130 "smurty_internal_templateparser.y"
    function yy_r4()
    {
        if ($this->compiler->has_code) {
            ...
            $this->compiler->prefix_code = array();
            $this->_retvalue = new _smurty_tag($this, $this->compiler->processNocacheCode($tmp . $this->yystack[$this->yyidx + - 1]->minor, true));
        } else {
            $this->_retvalue = null;
        }
        $this->compiler->has_variable_string = false;
    ...
    #line 2159 "smurty_internal_templateparser.php"
    #line 142 "smurty_internal_templateparser.y"
    function yy_r5()
    {
        $this->_retvalue = null;
    }
    #line 2164 "smurty_internal_templateparser.php"
    #line 147 "smurty_internal_templateparser.y"
    function yy_r6()
    {
        $this->_retvalue = new _smurty_text($this, $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2169 "smurty_internal_templateparser.php"
    #line 152 "smurty_internal_templateparser.y"
    function yy_r7()
    {
        if (strpos($this->yystack[$this->yyidx + 0]->minor, '<s') === 0) {
            $this->lex->is_phpScript = true;
        }
        if ($this->php_handling == hiweb_tpl::PHP_PASSTHRU) {
            $this->_retvalue = new _smurty_text($this, self::escape_start_tag($this->yystack[$this->yyidx + 0]->minor));
        } elseif ($this->php_handling == hiweb_tpl::PHP_QUOTE) {
            $this->_retvalue = new _smurty_text($this, htmlspecialchars($this->yystack[$this->yyidx + 0]->minor, ENT_QUOTES));
        } elseif ($this->php_handling == hiweb_tpl::PHP_ALLOW) {
            if (!($this->smurty instanceof hiweb_tplChild)) {
                $this->compiler->trigger_template_error(self::Err3);
            }
            $this->_retvalue = new _smurty_text($this, $this->compiler->processNocacheCode('<?php ', true));
        } elseif ($this->php_handling == hiweb_tpl::PHP_REMOVE) {
            $this->_retvalue = null;
        }
    }
    #line 2188 "smurty_internal_templateparser.php"
    #line 171 "smurty_internal_templateparser.y"
    function yy_r8()
    {
        if ($this->is_xml) {
            ...
            $this->_retvalue = new _smurty_text($this, $this->compiler->processNocacheCode("<?php echo '?>';?>\n", $this->compiler, true));
            $this->template->has_nocache_code = $save;
        } elseif ($this->php_handling == hiweb_tpl::PHP_PASSTHRU) {
            $this->_retvalue = new _smurty_text($this, '?<?php ?>>');
        } elseif ($this->php_handling == hiweb_tpl::PHP_QUOTE) {
            $this->_retvalue = new _smurty_text($this, htmlspecialchars('?>', ENT_QUOTES));
        } elseif ($this->php_handling == hiweb_tpl::PHP_ALLOW) {
            $this->_retvalue = new _smurty_text($this, $this->compiler->processNocacheCode('?>', true));
        } elseif ($this->php_handling == hiweb_tpl::PHP_REMOVE) {
            $this->_retvalue = null;
        }
    }
    #line 2207 "smurty_internal_templateparser.php"
    #line 189 "smurty_internal_templateparser.y"
    function yy_r9()
    {
    ...
    #line 2225 "smurty_internal_templateparser.php"
    #line 207 "smurty_internal_templateparser.y"
    function yy_r10()
    {
        if ($this->php_handling == hiweb_tpl::PHP_PASSTHRU) {
            $this->_retvalue = new _smurty_text($this, '<<?php ?>%');
    ...
    #line 2249 "smurty_internal_templateparser.php"
    #line 231 "smurty_internal_templateparser.y"
    function yy_r11()
    {
        if ($this->php_handling == hiweb_tpl::PHP_PASSTHRU) {
            $this->_retvalue = new _smurty_text($this, '%<?php ?>>');
    ...
    #line 2270 "smurty_internal_templateparser.php"
    #line 251 "smurty_internal_templateparser.y"
    function yy_r12()
    {
        if ($this->strip) {
            $this->_retvalue = new _smurty_text($this, preg_replace('![\t ]*[\r\n]+[\t ]*!', '', self::escape_start_tag($this->yystack[$this->yyidx + 0]->minor)));
        } else {
            $this->_retvalue = new _smurty_text($this, self::escape_start_tag($this->yystack[$this->yyidx + 0]->minor));
        }
    }
    #line 2279 "smurty_internal_templateparser.php"
    #line 260 "smurty_internal_templateparser.y"
    function yy_r13()
    {
        $this->compiler->tag_nocache = true;
        $this->is_xml = true;
        $save = $this->template->has_nocache_code;
        $this->_retvalue = new _smurty_text($this, $this->compiler->processNocacheCode("<?php echo '<?xml';?>", $this->compiler, true));
        $this->template->has_nocache_code = $save;
    }
    #line 2288 "smurty_internal_templateparser.php"
    #line 269 "smurty_internal_templateparser.y"
    function yy_r14()
    {
        if ($this->strip) {
    ...
    #line 2297 "smurty_internal_templateparser.php"
    #line 278 "smurty_internal_templateparser.y"
    function yy_r15()
    {
        $this->strip = true;
    }
    #line 2302 "smurty_internal_templateparser.php"
    #line 282 "smurty_internal_templateparser.y"
    function yy_r16()
    {
        $this->strip = false;
    }
    #line 2307 "smurty_internal_templateparser.php"
    #line 286 "smurty_internal_templateparser.y"
    function yy_r17()
    {
        if ($this->strip) {
            SMURTY_INTERNAL_COMPILE_BLOCK::blockSource($this->compiler, preg_replace('![\t ]*[\r\n]+[\t ]*!', '', $this->yystack[$this->yyidx + 0]->minor));
        } else {
            SMURTY_INTERNAL_COMPILE_BLOCK::blockSource($this->compiler, $this->yystack[$this->yyidx + 0]->minor);
        }
    }
    #line 2316 "smurty_internal_templateparser.php"
    #line 295 "smurty_internal_templateparser.y"
    function yy_r18()
    {
        $this->_retvalue = '';
    }
    #line 2321 "smurty_internal_templateparser.php"
    #line 299 "smurty_internal_templateparser.y"
    function yy_r19()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 1]->minor;
    }
    #line 2326 "smurty_internal_templateparser.php"
    #line 303 "smurty_internal_templateparser.y"
    function yy_r20()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 1]->minor . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2331 "smurty_internal_templateparser.php"
    #line 311 "smurty_internal_templateparser.y"
    function yy_r22()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2336 "smurty_internal_templateparser.php"
    #line 319 "smurty_internal_templateparser.y"
    function yy_r24()
    {
        $this->_retvalue = self::escape_start_tag($this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2341 "smurty_internal_templateparser.php"
    #line 327 "smurty_internal_templateparser.y"
    function yy_r26()
    {
        $this->_retvalue = self::escape_end_tag($this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2346 "smurty_internal_templateparser.php"
    #line 331 "smurty_internal_templateparser.y"
    function yy_r27()
    {
        $this->_retvalue = '<<?php ?>%';
    }
    #line 2351 "smurty_internal_templateparser.php"
    #line 335 "smurty_internal_templateparser.y"
    function yy_r28()
    {
        $this->_retvalue = '%<?php ?>>';
    }
    #line 2356 "smurty_internal_templateparser.php"
    #line 344 "smurty_internal_templateparser.y"
    function yy_r29()
    {
        $this->_retvalue = $this->compiler->compileTag('private_print_expression', array(), array('value' => $this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2361 "smurty_internal_templateparser.php"
    #line 348 "smurty_internal_templateparser.y"
    function yy_r30()
    {
    ...
    #line 2366 "smurty_internal_templateparser.php"
    #line 352 "smurty_internal_templateparser.y"
    function yy_r31()
    {
        $this->_retvalue = $this->compiler->compileTag('private_print_expression', $this->yystack[$this->yyidx + 0]->minor, array('value' => $this->yystack[$this->yyidx + - 1]->minor));
    }
    #line 2371 "smurty_internal_templateparser.php"
    #line 356 "smurty_internal_templateparser.y"
    function yy_r32()
    {
        $this->_retvalue = $this->compiler->compileTag('private_print_expression', $this->yystack[$this->yyidx + 0]->minor, array('value' => $this->yystack[$this->yyidx + - 2]->minor, 'modifierlist' => $this->yystack[$this->yyidx + - 1]->minor));
    }
    #line 2376 "smurty_internal_templateparser.php"
    #line 369 "smurty_internal_templateparser.y"
    function yy_r34()
    {
    ...
    #line 2381 "smurty_internal_templateparser.php"
    #line 377 "smurty_internal_templateparser.y"
    function yy_r36()
    {
    ...
    #line 2386 "smurty_internal_templateparser.php"
    #line 381 "smurty_internal_templateparser.y"
    function yy_r37()
    {
        $this->_retvalue = $this->compiler->compileTag('assign', array_merge(array(array('value' => $this->yystack[$this->yyidx + - 1]->minor), array('var' => $this->yystack[$this->yyidx + - 3]->minor['var'])), $this->yystack[$this->yyidx + 0]->minor), array('smurty_internal_index' => $this->yystack[$this->yyidx + - 3]->minor['smurty_internal_index']));
    }
    #line 2391 "smurty_internal_templateparser.php"
    #line 386 "smurty_internal_templateparser.y"
    function yy_r38()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + - 1]->minor, $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2396 "smurty_internal_templateparser.php"
    #line 390 "smurty_internal_templateparser.y"
    function yy_r39()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + 0]->minor, array());
    }
    #line 2401 "smurty_internal_templateparser.php"
    #line 395 "smurty_internal_templateparser.y"
    function yy_r40()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + - 3]->minor, $this->yystack[$this->yyidx + 0]->minor, array('object_method' => $this->yystack[$this->yyidx + - 1]->minor));
    }
    #line 2406 "smurty_internal_templateparser.php"
    #line 400 "smurty_internal_templateparser.y"
    function yy_r41()
    {
    ...
    #line 2412 "smurty_internal_templateparser.php"
    #line 406 "smurty_internal_templateparser.y"
    function yy_r42()
    {
    ...
    #line 2418 "smurty_internal_templateparser.php"
    #line 412 "smurty_internal_templateparser.y"
    function yy_r43()
    {
        $tag = trim(substr($this->yystack[$this->yyidx + - 1]->minor, $this->lex->ldel_length));
        $this->_retvalue = $this->compiler->compileTag(($tag == 'else if') ? 'elseif' : $tag, array(), array('if condition' => $this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2424 "smurty_internal_templateparser.php"
    #line 417 "smurty_internal_templateparser.y"
    function yy_r44()
    {
        $tag = trim(substr($this->yystack[$this->yyidx + - 2]->minor, $this->lex->ldel_length));
        $this->_retvalue = $this->compiler->compileTag(($tag == 'else if') ? 'elseif' : $tag, $this->yystack[$this->yyidx + 0]->minor, array('if condition' => $this->yystack[$this->yyidx + - 1]->minor));
    }
    #line 2430 "smurty_internal_templateparser.php"
    #line 422 "smurty_internal_templateparser.y"
    function yy_r45()
    {
        $tag = trim(substr($this->yystack[$this->yyidx + - 1]->minor, $this->lex->ldel_length));
        $this->_retvalue = $this->compiler->compileTag(($tag == 'else if') ? 'elseif' : $tag, array(), array('if condition' => $this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2436 "smurty_internal_templateparser.php"
    #line 433 "smurty_internal_templateparser.y"
    function yy_r47()
    {
    ...
    #line 2441 "smurty_internal_templateparser.php"
    #line 437 "smurty_internal_templateparser.y"
    function yy_r48()
    {
        $this->_retvalue = '=' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2446 "smurty_internal_templateparser.php"
    #line 445 "smurty_internal_templateparser.y"
    function yy_r50()
    {
        $this->_retvalue = $this->compiler->compileTag('for', array_merge($this->yystack[$this->yyidx + 0]->minor, array(array('start' => $this->yystack[$this->yyidx + - 3]->minor), array('to' => $this->yystack[$this->yyidx + - 1]->minor))), 0);
    }
    #line 2451 "smurty_internal_templateparser.php"
    #line 449 "smurty_internal_templateparser.y"
    function yy_r51()
    {
        $this->_retvalue = $this->compiler->compileTag('for', array_merge($this->yystack[$this->yyidx + 0]->minor, array(array('start' => $this->yystack[$this->yyidx + - 5]->minor), array('to' => $this->yystack[$this->yyidx + - 3]->minor), array('step' => $this->yystack[$this->yyidx + - 1]->minor))), 0);
    }
    #line 2456 "smurty_internal_templateparser.php"
    #line 454 "smurty_internal_templateparser.y"
    function yy_r52()
    {
        $this->_retvalue = $this->compiler->compileTag('foreach', $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2461 "smurty_internal_templateparser.php"
    #line 459 "smurty_internal_templateparser.y"
    function yy_r53()
    {
    ...
    #line 2466 "smurty_internal_templateparser.php"
    #line 463 "smurty_internal_templateparser.y"
    function yy_r54()
    {
    ...
    #line 2471 "smurty_internal_templateparser.php"
    #line 476 "smurty_internal_templateparser.y"
    function yy_r57()
    {
        $this->_retvalue = $this->compiler->compileTag('setfilter', array(), array('modifier_list' => array(array_merge(array($this->yystack[$this->yyidx + - 1]->minor), $this->yystack[$this->yyidx + 0]->minor))));
    }
    #line 2476 "smurty_internal_templateparser.php"
    #line 480 "smurty_internal_templateparser.y"
    function yy_r58()
    {
        $this->_retvalue = $this->compiler->compileTag('setfilter', array(), array('modifier_list' => array_merge(array(array_merge(array($this->yystack[$this->yyidx + - 2]->minor), $this->yystack[$this->yyidx + - 1]->minor)), $this->yystack[$this->yyidx + 0]->minor)));
    }
    #line 2481 "smurty_internal_templateparser.php"
    #line 485 "smurty_internal_templateparser.y"
    function yy_r59()
    {
        $j = strrpos($this->yystack[$this->yyidx + 0]->minor, '.');
        if ($this->yystack[$this->yyidx + 0]->minor[$j + 1] == 'c') {
            // {$smurty.block.child}
            $this->_retvalue = SMURTY_INTERNAL_COMPILE_BLOCK::compileChildBlock($this->compiler);
        } else {
            // {$smurty.block.parent}
            $this->_retvalue = SMURTY_INTERNAL_COMPILE_BLOCK::compileParentBlock($this->compiler);
        }
    }
    #line 2493 "smurty_internal_templateparser.php"
    #line 498 "smurty_internal_templateparser.y"
    function yy_r60()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + 0]->minor . 'close', array());
    }
    #line 2498 "smurty_internal_templateparser.php"
    #line 502 "smurty_internal_templateparser.y"
    function yy_r61()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + - 1]->minor . 'close', array(), array('modifier_list' => $this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2503 "smurty_internal_templateparser.php"
    #line 507 "smurty_internal_templateparser.y"
    function yy_r62()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + - 2]->minor . 'close', array(), array('object_method' => $this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2508 "smurty_internal_templateparser.php"
    #line 511 "smurty_internal_templateparser.y"
    function yy_r63()
    {
        $this->_retvalue = $this->compiler->compileTag($this->yystack[$this->yyidx + - 3]->minor . 'close', array(), array('object_method' => $this->yystack[$this->yyidx + - 1]->minor, 'modifier_list' => $this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2513 "smurty_internal_templateparser.php"
    #line 519 "smurty_internal_templateparser.y"
    function yy_r64()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 1]->minor;
        $this->_retvalue[] = $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2519 "smurty_internal_templateparser.php"
    #line 525 "smurty_internal_templateparser.y"
    function yy_r65()
    {
        $this->_retvalue = array($this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2524 "smurty_internal_templateparser.php"
    #line 530 "smurty_internal_templateparser.y"
    function yy_r66()
    {
        $this->_retvalue = array();
    }
    #line 2529 "smurty_internal_templateparser.php"
    #line 535 "smurty_internal_templateparser.y"
    function yy_r67()
    {
    ...
    #line 2542 "smurty_internal_templateparser.php"
    #line 547 "smurty_internal_templateparser.y"
    function yy_r68()
    {
        $this->_retvalue = array(trim($this->yystack[$this->yyidx + - 1]->minor, " =\n\r\t") => $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2547 "smurty_internal_templateparser.php"
    #line 555 "smurty_internal_templateparser.y"
    function yy_r70()
    {
        $this->_retvalue = "'" . $this->yystack[$this->yyidx + 0]->minor . "'";
    }
    #line 2552 "smurty_internal_templateparser.php"
    #line 567 "smurty_internal_templateparser.y"
    function yy_r73()
    {
        $this->_retvalue = array($this->yystack[$this->yyidx + - 2]->minor => $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2557 "smurty_internal_templateparser.php"
    #line 580 "smurty_internal_templateparser.y"
    function yy_r75()
    {
        $this->yystack[$this->yyidx + - 2]->minor[] = $this->yystack[$this->yyidx + 0]->minor;
        $this->_retvalue = $this->yystack[$this->yyidx + - 2]->minor;
    }
    #line 2563 "smurty_internal_templateparser.php"
    #line 585 "smurty_internal_templateparser.y"
    function yy_r76()
    {
        $this->_retvalue = array('var' => $this->yystack[$this->yyidx + - 2]->minor, 'value' => $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2568 "smurty_internal_templateparser.php"
    #line 613 "smurty_internal_templateparser.y"
    function yy_r81()
    {
        $this->_retvalue = '$_smurty_tpl->getStreamVariable(\'' . $this->yystack[$this->yyidx + - 2]->minor . '://' . $this->yystack[$this->yyidx + 0]->minor . '\')';
    }
    #line 2573 "smurty_internal_templateparser.php"
    #line 618 "smurty_internal_templateparser.y"
    function yy_r82()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 2]->minor . trim($this->yystack[$this->yyidx + - 1]->minor) . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2578 "smurty_internal_templateparser.php"
    #line 637 "smurty_internal_templateparser.y"
    function yy_r86()
    {
        $this->_retvalue = $this->compiler->compileTag('private_modifier', array(), array('value' => $this->yystack[$this->yyidx + - 1]->minor, 'modifierlist' => $this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2583 "smurty_internal_templateparser.php"
    #line 643 "smurty_internal_templateparser.y"
    function yy_r87()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 2]->minor . $this->yystack[$this->yyidx + - 1]->minor . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2588 "smurty_internal_templateparser.php"
    #line 647 "smurty_internal_templateparser.y"
    function yy_r88()
    {
        $this->_retvalue = 'in_array(' . $this->yystack[$this->yyidx + - 2]->minor . ',' . $this->yystack[$this->yyidx + 0]->minor . ')';
    }
    #line 2593 "smurty_internal_templateparser.php"
    #line 651 "smurty_internal_templateparser.y"
    function yy_r89()
    {
        $this->_retvalue = 'in_array(' . $this->yystack[$this->yyidx + - 2]->minor . ',(array)' . $this->yystack[$this->yyidx + 0]->minor . ')';
    }
    #line 2598 "smurty_internal_templateparser.php"
    #line 659 "smurty_internal_templateparser.y"
    function yy_r91()
    {
        $this->_retvalue = '!(' . $this->yystack[$this->yyidx + - 2]->minor . ' % ' . $this->yystack[$this->yyidx + 0]->minor . ')';
    }
    #line 2603 "smurty_internal_templateparser.php"
    #line 663 "smurty_internal_templateparser.y"
    function yy_r92()
    {
        $this->_retvalue = '(' . $this->yystack[$this->yyidx + - 2]->minor . ' % ' . $this->yystack[$this->yyidx + 0]->minor . ')';
    }
    #line 2608 "smurty_internal_templateparser.php"
    #line 667 "smurty_internal_templateparser.y"
    function yy_r93()
    {
        $this->_retvalue = '!(1 & ' . $this->yystack[$this->yyidx + - 1]->minor . ')';
    }
    #line 2613 "smurty_internal_templateparser.php"
    #line 671 "smurty_internal_templateparser.y"
    function yy_r94()
    {
        $this->_retvalue = '(1 & ' . $this->yystack[$this->yyidx + - 1]->minor . ')';
    }
    #line 2618 "smurty_internal_templateparser.php"
    #line 675 "smurty_internal_templateparser.y"
    function yy_r95()
    {
        $this->_retvalue = '!(1 & ' . $this->yystack[$this->yyidx + - 2]->minor . ' / ' . $this->yystack[$this->yyidx + 0]->minor . ')';
    }
    #line 2623 "smurty_internal_templateparser.php"
    #line 679 "smurty_internal_templateparser.y"
    function yy_r96()
    {
        $this->_retvalue = '(1 & ' . $this->yystack[$this->yyidx + - 2]->minor . ' / ' . $this->yystack[$this->yyidx + 0]->minor . ')';
    }
    #line 2628 "smurty_internal_templateparser.php"
    #line 703 "smurty_internal_templateparser.y"
    function yy_r102()
    {
        self::$prefix_number ++;
    ...
    #line 2635 "smurty_internal_templateparser.php"
    #line 712 "smurty_internal_templateparser.y"
    function yy_r103()
    {
    ...
    #line 2640 "smurty_internal_templateparser.php"
    #line 716 "smurty_internal_templateparser.y"
    function yy_r104()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 5]->minor . ' ? ' . $this->yystack[$this->yyidx + - 2]->minor . ' : ' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2645 "smurty_internal_templateparser.php"
    #line 731 "smurty_internal_templateparser.y"
    function yy_r107()
    {
        $this->_retvalue = '!' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2650 "smurty_internal_templateparser.php"
    #line 752 "smurty_internal_templateparser.y"
    function yy_r112()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 2]->minor . '.' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2655 "smurty_internal_templateparser.php"
    #line 756 "smurty_internal_templateparser.y"
    function yy_r113()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 1]->minor . '.';
    }
    #line 2660 "smurty_internal_templateparser.php"
    #line 760 "smurty_internal_templateparser.y"
    function yy_r114()
    {
        $this->_retvalue = '.' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2665 "smurty_internal_templateparser.php"
    #line 765 "smurty_internal_templateparser.y"
    function yy_r115()
    {
        if (preg_match('~^true$~i', $this->yystack[$this->yyidx + 0]->minor)) {
            $this->_retvalue = 'true';
    ...
    #line 2678 "smurty_internal_templateparser.php"
    #line 783 "smurty_internal_templateparser.y"
    function yy_r117()
    {
        $this->_retvalue = "(" . $this->yystack[$this->yyidx + - 1]->minor . ")";
    }
    #line 2683 "smurty_internal_templateparser.php"
    #line 798 "smurty_internal_templateparser.y"
    function yy_r120()
    {
        if (!$this->security || isset($this->smurty->registered_classes[$this->yystack[$this->yyidx + - 2]->minor]) || $this->smurty->security_policy->isTrustedStaticClass($this->yystack[$this->yyidx + - 2]->minor, $this->compiler)) {
            if (isset($this->smurty->registered_classes[$this->yystack[$this->yyidx + - 2]->minor])) {
                $this->_retvalue = $this->smurty->registered_classes[$this->yystack[$this->yyidx + - 2]->minor] . '::' . $this->yystack[$this->yyidx + 0]->minor;
            } else {
                $this->_retvalue = $this->yystack[$this->yyidx + - 2]->minor . '::' . $this->yystack[$this->yyidx + 0]->minor;
            }
        } else {
    ...
    #line 2696 "smurty_internal_templateparser.php"
    #line 810 "smurty_internal_templateparser.y"
    function yy_r121()
    {
        if ($this->yystack[$this->yyidx + - 2]->minor['var'] == '\'smurty\'') {
            $this->_retvalue = $this->compiler->compileTag('private_special_variable', array(), $this->yystack[$this->yyidx + - 2]->minor['smurty_internal_index']) . '::' . $this->yystack[$this->yyidx + 0]->minor;
        } else {
            $this->_retvalue = $this->compileVariable($this->yystack[$this->yyidx + - 2]->minor['var']) . $this->yystack[$this->yyidx + - 2]->minor['smurty_internal_index'] . '::' . $this->yystack[$this->yyidx + 0]->minor;
        }
    }
    #line 2705 "smurty_internal_templateparser.php"
    #line 819 "smurty_internal_templateparser.y"
    function yy_r122()
    {
        self::$prefix_number ++;
    ...
    #line 2712 "smurty_internal_templateparser.php"
    #line 834 "smurty_internal_templateparser.y"
    function yy_r124()
    {
        if ($this->yystack[$this->yyidx + 0]->minor['var'] == '\'smurty\'') {
            $smurty_var = $this->compiler->compileTag('private_special_variable', array(), $this->yystack[$this->yyidx + 0]->minor['smurty_internal_index']);
            $this->_retvalue = $smurty_var;
        } else {
            // used for array reset,next,prev,end,current 
            $this->last_variable = $this->yystack[$this->yyidx + 0]->minor['var'];
            $this->last_index = $this->yystack[$this->yyidx + 0]->minor['smurty_internal_index'];
            $this->_retvalue = $this->compileVariable($this->yystack[$this->yyidx + 0]->minor['var']) . $this->yystack[$this->yyidx + 0]->minor['smurty_internal_index'];
        }
    }
    #line 2725 "smurty_internal_templateparser.php"
    #line 847 "smurty_internal_templateparser.y"
    function yy_r125()
    {
        $this->_retvalue = '$_smurty_tpl->tpl_vars[' . $this->yystack[$this->yyidx + - 2]->minor . ']->' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2730 "smurty_internal_templateparser.php"
    #line 857 "smurty_internal_templateparser.y"
    function yy_r127()
    {
        $this->_retvalue = '$_smurty_tpl->getConfigVariable(\'' . $this->yystack[$this->yyidx + - 1]->minor . '\')';
    }
    #line 2735 "smurty_internal_templateparser.php"
    #line 861 "smurty_internal_templateparser.y"
    function yy_r128()
    {
        $this->_retvalue = '(is_array($tmp = $_smurty_tpl->getConfigVariable(\'' . $this->yystack[$this->yyidx + - 2]->minor . '\')) ? $tmp' . $this->yystack[$this->yyidx + 0]->minor . ' :null)';
    }
    #line 2740 "smurty_internal_templateparser.php"
    #line 865 "smurty_internal_templateparser.y"
    function yy_r129()
    {
        $this->_retvalue = '$_smurty_tpl->getConfigVariable(' . $this->yystack[$this->yyidx + - 1]->minor . ')';
    }
    #line 2745 "smurty_internal_templateparser.php"
    #line 869 "smurty_internal_templateparser.y"
    function yy_r130()
    {
        $this->_retvalue = '(is_array($tmp = $_smurty_tpl->getConfigVariable(' . $this->yystack[$this->yyidx + - 2]->minor . ')) ? $tmp' . $this->yystack[$this->yyidx + 0]->minor . ' : null)';
    }
    #line 2750 "smurty_internal_templateparser.php"
    #line 873 "smurty_internal_templateparser.y"
    function yy_r131()
    {
        $this->_retvalue = array('var' => $this->yystack[$this->yyidx + - 1]->minor, 'smurty_internal_index' => $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2755 "smurty_internal_templateparser.php"
    #line 886 "smurty_internal_templateparser.y"
    function yy_r133()
    {
        return;
    }
    #line 2760 "smurty_internal_templateparser.php"
    #line 892 "smurty_internal_templateparser.y"
    function yy_r134()
    {
        $this->_retvalue = '[' . $this->compileVariable($this->yystack[$this->yyidx + 0]->minor) . ']';
    }
    #line 2765 "smurty_internal_templateparser.php"
    #line 896 "smurty_internal_templateparser.y"
    function yy_r135()
    {
        $this->_retvalue = '[' . $this->compileVariable($this->yystack[$this->yyidx + - 2]->minor) . '->' . $this->yystack[$this->yyidx + 0]->minor . ']';
    }
    #line 2770 "smurty_internal_templateparser.php"
    #line 900 "smurty_internal_templateparser.y"
    function yy_r136()
    {
        $this->_retvalue = "['" . $this->yystack[$this->yyidx + 0]->minor . "']";
    }
    #line 2775 "smurty_internal_templateparser.php"
    #line 904 "smurty_internal_templateparser.y"
    function yy_r137()
    {
        $this->_retvalue = "[" . $this->yystack[$this->yyidx + 0]->minor . "]";
    }
    #line 2780 "smurty_internal_templateparser.php"
    #line 908 "smurty_internal_templateparser.y"
    function yy_r138()
    {
        $this->_retvalue = "[" . $this->yystack[$this->yyidx + - 1]->minor . "]";
    }
    #line 2785 "smurty_internal_templateparser.php"
    #line 913 "smurty_internal_templateparser.y"
    function yy_r139()
    {
        $this->_retvalue = '[' . $this->compiler->compileTag('private_special_variable', array(), '[\'section\'][\'' . $this->yystack[$this->yyidx + - 1]->minor . '\'][\'index\']') . ']';
    }
    #line 2790 "smurty_internal_templateparser.php"
    #line 917 "smurty_internal_templateparser.y"
    function yy_r140()
    {
        $this->_retvalue = '[' . $this->compiler->compileTag('private_special_variable', array(), '[\'section\'][\'' . $this->yystack[$this->yyidx + - 3]->minor . '\'][\'' . $this->yystack[$this->yyidx + - 1]->minor . '\']') . ']';
    }
    #line 2795 "smurty_internal_templateparser.php"
    #line 927 "smurty_internal_templateparser.y"
    function yy_r142()
    {
        $this->_retvalue = '[]';
    }
    #line 2800 "smurty_internal_templateparser.php"
    #line 940 "smurty_internal_templateparser.y"
    function yy_r144()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 1]->minor . '.' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2805 "smurty_internal_templateparser.php"
    #line 945 "smurty_internal_templateparser.y"
    function yy_r145()
    {
        $this->_retvalue = '\'' . $this->yystack[$this->yyidx + 0]->minor . '\'';
    }
    #line 2810 "smurty_internal_templateparser.php"
    #line 950 "smurty_internal_templateparser.y"
    function yy_r146()
    {
        $this->_retvalue = '(' . $this->yystack[$this->yyidx + - 1]->minor . ')';
    }
    #line 2815 "smurty_internal_templateparser.php"
    #line 957 "smurty_internal_templateparser.y"
    function yy_r147()
    {
        if ($this->yystack[$this->yyidx + - 1]->minor['var'] == '\'smurty\'') {
            $this->_retvalue = $this->compiler->compileTag('private_special_variable', array(), $this->yystack[$this->yyidx + - 1]->minor['smurty_internal_index']) . $this->yystack[$this->yyidx + 0]->minor;
        } else {
            $this->_retvalue = $this->compileVariable($this->yystack[$this->yyidx + - 1]->minor['var']) . $this->yystack[$this->yyidx + - 1]->minor['smurty_internal_index'] . $this->yystack[$this->yyidx + 0]->minor;
        }
    }
    #line 2824 "smurty_internal_templateparser.php"
    #line 966 "smurty_internal_templateparser.y"
    function yy_r148()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2829 "smurty_internal_templateparser.php"
    #line 971 "smurty_internal_templateparser.y"
    function yy_r149()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 1]->minor . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2834 "smurty_internal_templateparser.php"
    #line 976 "smurty_internal_templateparser.y"
    function yy_r150()
    {
    ...
    #line 2842 "smurty_internal_templateparser.php"
    #line 983 "smurty_internal_templateparser.y"
    function yy_r151()
    {
        if ($this->security) {
    ...
    #line 2850 "smurty_internal_templateparser.php"
    #line 990 "smurty_internal_templateparser.y"
    function yy_r152()
    {
        if ($this->security) {
            $this->compiler->trigger_template_error(self::Err2);
    ...
    #line 2858 "smurty_internal_templateparser.php"
    #line 997 "smurty_internal_templateparser.y"
    function yy_r153()
    {
        if ($this->security) {
            $this->compiler->trigger_template_error(self::Err2);
    ...
    #line 2866 "smurty_internal_templateparser.php"
    #line 1005 "smurty_internal_templateparser.y"
    function yy_r154()
    {
        $this->_retvalue = '->' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2871 "smurty_internal_templateparser.php"
    #line 1013 "smurty_internal_templateparser.y"
    function yy_r155()
    {
        if (!$this->security || $this->smurty->security_policy->isTrustedPhpFunction($this->yystack[$this->yyidx + - 3]->minor, $this->compiler)) {
            if (strcasecmp($this->yystack[$this->yyidx + - 3]->minor, 'isset') === 0 || strcasecmp($this->yystack[$this->yyidx + - 3]->minor, 'empty') === 0 || strcasecmp($this->yystack[$this->yyidx + - 3]->minor, 'array') === 0 || is_callable($this->yystack[$this->yyidx + - 3]->minor)) {
                ...
                if ($func_name == 'isset') {
                    ...
                    if (strncasecmp($par, '$_smurty_tpl->getConfigVariable', strlen('$_smurty_tpl->getConfigVariable')) === 0) {
                        self::$prefix_number ++;
    ...
    #line 2907 "smurty_internal_templateparser.php"
    #line 1051 "smurty_internal_templateparser.y"
    function yy_r156()
    {
    ...
    #line 2915 "smurty_internal_templateparser.php"
    #line 1058 "smurty_internal_templateparser.y"
    function yy_r157()
    {
        if ($this->security) {
            $this->compiler->trigger_template_error(self::Err2);
    ...
    #line 2925 "smurty_internal_templateparser.php"
    #line 1069 "smurty_internal_templateparser.y"
    function yy_r158()
    {
        $this->_retvalue = array_merge($this->yystack[$this->yyidx + - 2]->minor, array($this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2930 "smurty_internal_templateparser.php"
    #line 1086 "smurty_internal_templateparser.y"
    function yy_r161()
    {
        $this->_retvalue = array_merge($this->yystack[$this->yyidx + - 2]->minor, array(array_merge($this->yystack[$this->yyidx + - 1]->minor, $this->yystack[$this->yyidx + 0]->minor)));
    }
    #line 2935 "smurty_internal_templateparser.php"
    #line 1090 "smurty_internal_templateparser.y"
    function yy_r162()
    {
        $this->_retvalue = array(array_merge($this->yystack[$this->yyidx + - 1]->minor, $this->yystack[$this->yyidx + 0]->minor));
    }
    #line 2940 "smurty_internal_templateparser.php"
    #line 1098 "smurty_internal_templateparser.y"
    function yy_r164()
    {
        $this->_retvalue = array($this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2945 "smurty_internal_templateparser.php"
    #line 1106 "smurty_internal_templateparser.y"
    function yy_r165()
    {
        $this->_retvalue = array_merge($this->yystack[$this->yyidx + - 1]->minor, $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 2950 "smurty_internal_templateparser.php"
    #line 1140 "smurty_internal_templateparser.y"
    function yy_r172()
    {
        $this->_retvalue = '$' . $this->yystack[$this->yyidx + - 1]->minor . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2955 "smurty_internal_templateparser.php"
    #line 1145 "smurty_internal_templateparser.y"
    function yy_r173()
    {
        $this->_retvalue = '$' . $this->yystack[$this->yyidx + - 2]->minor . $this->yystack[$this->yyidx + - 1]->minor . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 2960 "smurty_internal_templateparser.php"
    #line 1151 "smurty_internal_templateparser.y"
    function yy_r174()
    {
        $this->_retvalue = '==';
    }
    #line 2965 "smurty_internal_templateparser.php"
    #line 1155 "smurty_internal_templateparser.y"
    function yy_r175()
    {
        $this->_retvalue = '!=';
    }
    #line 2970 "smurty_internal_templateparser.php"
    #line 1159 "smurty_internal_templateparser.y"
    function yy_r176()
    {
        $this->_retvalue = '>';
    }
    #line 2975 "smurty_internal_templateparser.php"
    #line 1163 "smurty_internal_templateparser.y"
    function yy_r177()
    {
        $this->_retvalue = '<';
    }
    #line 2980 "smurty_internal_templateparser.php"
    #line 1167 "smurty_internal_templateparser.y"
    function yy_r178()
    {
        $this->_retvalue = '>=';
    }
    #line 2985 "smurty_internal_templateparser.php"
    #line 1171 "smurty_internal_templateparser.y"
    function yy_r179()
    {
        $this->_retvalue = '<=';
    }
    #line 2990 "smurty_internal_templateparser.php"
    #line 1175 "smurty_internal_templateparser.y"
    function yy_r180()
    {
        $this->_retvalue = '===';
    }
    #line 2995 "smurty_internal_templateparser.php"
    #line 1179 "smurty_internal_templateparser.y"
    function yy_r181()
    {
        $this->_retvalue = '!==';
    }
    #line 3000 "smurty_internal_templateparser.php"
    #line 1183 "smurty_internal_templateparser.y"
    function yy_r182()
    {
        $this->_retvalue = '%';
    }
    #line 3005 "smurty_internal_templateparser.php"
    #line 1187 "smurty_internal_templateparser.y"
    function yy_r183()
    {
        $this->_retvalue = '&&';
    }
    #line 3010 "smurty_internal_templateparser.php"
    #line 1191 "smurty_internal_templateparser.y"
    function yy_r184()
    {
        $this->_retvalue = '||';
    }
    #line 3015 "smurty_internal_templateparser.php"
    #line 1195 "smurty_internal_templateparser.y"
    function yy_r185()
    {
        $this->_retvalue = ' XOR ';
    }
    #line 3020 "smurty_internal_templateparser.php"
    #line 1202 "smurty_internal_templateparser.y"
    function yy_r186()
    {
        $this->_retvalue = 'array(' . $this->yystack[$this->yyidx + - 1]->minor . ')';
    }
    #line 3025 "smurty_internal_templateparser.php"
    #line 1210 "smurty_internal_templateparser.y"
    function yy_r188()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 2]->minor . ',' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 3030 "smurty_internal_templateparser.php"
    #line 1218 "smurty_internal_templateparser.y"
    function yy_r190()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 2]->minor . '=>' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 3035 "smurty_internal_templateparser.php"
    #line 1222 "smurty_internal_templateparser.y"
    function yy_r191()
    {
        $this->_retvalue = '\'' . $this->yystack[$this->yyidx + - 2]->minor . '\'=>' . $this->yystack[$this->yyidx + 0]->minor;
    }
    #line 3040 "smurty_internal_templateparser.php"
    #line 1234 "smurty_internal_templateparser.y"
    function yy_r193()
    {
        $this->_retvalue = "''";
    }
    #line 3045 "smurty_internal_templateparser.php"
    #line 1238 "smurty_internal_templateparser.y"
    function yy_r194()
    {
        $this->_retvalue = $this->yystack[$this->yyidx + - 1]->minor->to_smurty_php();
    }
    #line 3050 "smurty_internal_templateparser.php"
    #line 1243 "smurty_internal_templateparser.y"
    function yy_r195()
    {
        $this->yystack[$this->yyidx + - 1]->minor->append_subtree($this->yystack[$this->yyidx + 0]->minor);
        $this->_retvalue = $this->yystack[$this->yyidx + - 1]->minor;
    }
    #line 3056 "smurty_internal_templateparser.php"
    #line 1248 "smurty_internal_templateparser.y"
    function yy_r196()
    {
        $this->_retvalue = new _smurty_doublequoted($this, $this->yystack[$this->yyidx + 0]->minor);
    }
    #line 3061 "smurty_internal_templateparser.php"
    #line 1252 "smurty_internal_templateparser.y"
    function yy_r197()
    {
        $this->_retvalue = new _smurty_code($this, '(string)' . $this->yystack[$this->yyidx + - 1]->minor);
    }
    #line 3066 "smurty_internal_templateparser.php"
    #line 1260 "smurty_internal_templateparser.y"
    function yy_r199()
    {
        $this->_retvalue = new _smurty_code($this, '(string)$_smurty_tpl->tpl_vars[\'' . substr($this->yystack[$this->yyidx + 0]->minor, 1) . '\']->value');
    }
    #line 3071 "smurty_internal_templateparser.php"
    #line 1268 "smurty_internal_templateparser.y"
    function yy_r201()
    {
        $this->_retvalue = new _smurty_code($this, '(string)(' . $this->yystack[$this->yyidx + - 1]->minor . ')');
    }
    #line 3076 "smurty_internal_templateparser.php"
    #line 1272 "smurty_internal_templateparser.y"
    function yy_r202()
    {
        $this->_retvalue = new _smurty_tag($this, $this->yystack[$this->yyidx + - 1]->minor);
    }
    #line 3081 "smurty_internal_templateparser.php"
    #line 1276 "smurty_internal_templateparser.y"
    function yy_r203()
    {
        $this->_retvalue = new _smurty_dq_content($this, $this->yystack[$this->yyidx + 0]->minor);
    }

    #line 3086 "smurty_internal_templateparser.php"
    ...
    {
        #line 84 "smurty_internal_templateparser.y"

        $this->internalError = true;
        $this->yymajor = $yymajor;
        $this->compiler->trigger_template_error();
        #line 3148 "smurty_internal_templateparser.php"
    }
    ...
    public function yy_accept()
    {
        ...
        #line 76 "smurty_internal_templateparser.y"

        $this->successful = !$this->internalError;
        $this->internalError = false;
        $this->retvalue = $this->_retvalue;
        //echo $this->retvalue."\n\n";
        #line 3165 "smurty_internal_templateparser.php"
    }
