...
function smurty_function_html_select_time($params)
{
    ...
    if ($display_hours) {
        ...
        if ($hour_id !== null || $all_id !== null) {
            $_html_hours .= ' id="' . smurty_function_escape_special_chars(
    ...
    if ($display_minutes) {
        ...
        if ($minute_id !== null || $all_id !== null) {
            $_html_minutes .= ' id="' . smurty_function_escape_special_chars(
    ...
    if ($display_seconds) {
        ...
        if ($second_id !== null || $all_id !== null) {
            $_html_seconds .= ' id="' . smurty_function_escape_special_chars(
    ...
    if ($display_meridian && !$use_24_hours) {
        ...
        if ($meridian_id !== null || $all_id !== null) {
            $_html_meridian .= ' id="' . smurty_function_escape_special_chars(
