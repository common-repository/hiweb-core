...
function smurty_function_html_select_date($params)
{
    ...
    if ($display_years) {
        ...
        if ($year_as_text) {
            ...
            if ($year_id !== null || $all_id !== null) {
                $_html_years .= ' id="' . smurty_function_escape_special_chars(
    ...
    if ($display_months) {
        ...
        if ($month_id !== null || $all_id !== null) {
            $_html_months .= ' id="' . smurty_function_escape_special_chars(
    ...
    if ($display_days) {
        ...
        if ($day_id !== null || $all_id !== null) {
            $_html_days .= ' id="' . smurty_function_escape_special_chars(
